...
- Betreuung von Abschlussarbeiten (4 Studien- und 9 Diplom-/Masterarbeiten)
...
bibliography_entries("publications.bib") |>
  ...
  filter(
    grepl("zyabkina2024a|domagk2024a|blanco2024|bracale2023|domagk2023|zyabkina2022|domagk2022|domagk2021|domagk201[8-9]|zyabkina2018", id),
    !grepl("domagk2015$", id)
  )
```
...
bibliography_entries("presentations.bib") |>
  arrange(desc(issued), author$family) |>
  filter(grepl("vdetagung2023|ichqp2024panel|pmaps2022|wshopkcl2023", id))
```
